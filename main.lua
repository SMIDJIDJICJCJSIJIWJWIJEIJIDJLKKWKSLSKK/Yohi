		...
		if (not teleportedServers) and (not shared.VapeIndependent) then
			...
			local teleportScript =[[
				...
				if shared.VapeDeveloper then
					...
					loadstring(game:HttpGet('https://raw.githubusercontent.com/Spectatxr/Yohi/'..readfile('ReVape/profiles/commit.txt')..'/loader.lua', true), 'loader')()
				end
			]]
			if shared.VapeDeveloper then
...
loadstring(downloadFile('ReVape/games/universal.lua'), 'universal')()
	...
	if isfile('ReVape/games/'..game.PlaceId..'.lua') then
		...
		if not shared.VapeDeveloper then
			local suc, res = pcall(function()
				return game:HttpGet('https://raw.githubusercontent.com/Spectatxr/Yohi/'..readfile('ReVape/profiles/commit.txt')..'/games/'..game.PlaceId..'.lua', true)
			end)
